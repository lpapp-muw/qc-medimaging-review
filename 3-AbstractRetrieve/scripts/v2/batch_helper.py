...
INPUT = "v2_active/to_screen_v2.json"
VERDICTS = "v2_active/verdicts.jsonl"
QUARANTINE = "v2_active/quarantine.jsonl"
PENDING_DIR = "v2_active/pending"
...
def cmd_status():
    ...
    remaining_count = len([r for r in corpus if r.get("id") and r["id"] not in done])
