...
if __name__ == "__main__":
    ...
    print()
    print("Chunk threshold (A/B/C):", CHUNK_THRESHOLD_BYTES, "bytes")
    print("Chunk threshold (D)    :", CHUNK_THRESHOLD_PASS_D, "bytes")
    print("Chunk target size      :", CHUNK_TARGET_BYTES, "bytes")
    print("Chunk overlap          :", CHUNK_OVERLAP_BYTES, "bytes")
    print()
